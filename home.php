        ...
        if (count($errors) == 0) {
            ...
            if ($registro > 0) {
             ...
             haga click en el siguiente enlace <a href='$url'>Activar cuenta</a>";
                ...
                if (enviarEmail($correo_u, $nomb_u, $asunto, $cuerpo)) {
                    exit;
                } else {
            ...
            <div class="row">
                <div class="col-md-6">
                    <form name="formu" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                        ...
                        <input type="number" id="id_u" name="id_u" class="form-control" placeholder="Digite su numero de documento" value="<?php if (isset($id_u)) echo $id_u; ?>" required pattern="[0-9]{10}" title="Ingrese un numero valido">
                </div>
                <div class="col-md-6">
                ...
                <!--<div class="col-md-6">
                  ...
                  <input type="text" id="pregunta_u" name="pregunta_u" class="form-control" placeholder="Digite su color favorito" required>
              </div>-->
                
                <div class="col-md-4 mt-4">
                    <!--<center><input type="button" value="Registrar" class="btn btn-success" title="Registrar" onclick="validaru();"></center>-->
